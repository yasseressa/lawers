					...
					<div class="card border-0 shadow rounded-3 my-5">
					  <div class="card-body p-4 p-sm-5">
						...
						<form method="post" action="{{route('post_signup')}}">
						  ...
						  <div class="form-floating mb-3">
							<input type="number" name="age" min="0" max="100" class="form-control" id="floatingAge" placeholder="25">
						  ...
						  <div class="form-floating mb-3">
							<input type="text" name="address" class="form-control" id="floatingAddress" placeholder="KSA">
						  ...
						  <div class="form-floating mb-3">
							<input type="password" name="confirm" class="form-control" id="floatingConfirm" placeholder="Password" required>
